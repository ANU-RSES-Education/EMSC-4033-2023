"""
The streamlit_app.py program is a program that offer a 
streamlined dashboard experience on Streamlit, allowing users 
to explore and interact with the dashboard.

The inputs of this program are the outputs generated by oq_calculation.py
alongside predefined shapefile (*.shp) data.

After executing this program, Streamlit server starts, and you can 
access the dashboard by opening the provided local URL in your web browser.
"""
...
def load_data(calculation_id):
    ...
    avg_gmf_path = os.path.join(current_dir, "output", "avg_gmf_" + calculation_id + ".csv")
    ...
    avg_damage_path = os.path.join(current_dir, "output", "avg_damages-rlz-000_" + calculation_id + ".csv")
    ...
    csv_path = os.path.join(os.getcwd(), "output", "fragility_model" + ".csv")
